...
public class SpecialistController {
    ...
    public ResponseEntity<List<Specialist>> getTopRatedSpecialists(
            @RequestParam(defaultValue = "5") int limit) {
        List<Specialist> specialists = specialistService.getTopRatedSpecialists(limit);
        return new ResponseEntity<>(specialists, HttpStatus.OK);
    }
    @GetMapping("/top-type-experience")
    public ResponseEntity<Object> getTypeSpecialistWithMostExperience() {
        Object result = specialistService.getTypeSpecialistWithMostExperience();
